...
class Vector3 : public ::Vector3 {
 public:
    ...
    inline Vector3 &DrawLine3D(const ::Vector3 &endPos, const ::Color &color) {
        ::DrawLine3D(*this, endPos, color);
        return *this;
    }

    inline Vector3 &DrawPoint3D(const ::Color &color) {
    ...
    inline Vector3 &DrawCube(float width, float height, float length, const ::Color &color) {
        ::DrawCube(*this, width, height, length, color);
        return *this;
    }

    inline Vector3 &DrawCube(const ::Vector3 &size, const ::Color &color) {
        ::DrawCubeV(*this, size, color);
        return *this;
    }

    inline Vector3 &DrawCubeWires(float width, float height, float length, const ::Color &color) {
        ::DrawCubeWires(*this, width, height, length, color);
        return *this;
    }

    inline Vector3 &DrawCubeWires(const ::Vector3 &size, const ::Color &color) {
    ...
    inline Vector3 &DrawSphere(float radius, const ::Color &color) {
        ::DrawSphere(*this, radius, color);
        return *this;
    }

    inline Vector3 &DrawSphere(float radius, int rings, int slices, const ::Color &color) {
        ::DrawSphereEx(*this, radius, rings, slices, color);
        return *this;
    }

    inline Vector3 &DrawSphereWires(float radius, int rings, int slices, const ::Color &color) {
    ...
    inline Vector3 &DrawPlane(const ::Vector2& size, const ::Color &color) {
