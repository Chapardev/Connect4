...
class Vector2 : public ::Vector2 {
 public:
    ...
    inline Vector2 &DrawPixel(const ::Color &color) {
        ::DrawPixelV(*this, color);
        return *this;
    }

    inline Vector2 &DrawLine(const ::Vector2 &endPos, const ::Color &color) {
        ::DrawLineV(*this, endPos, color);
        return *this;
    }

    inline Vector2 &DrawLine(const ::Vector2 &endPos, float thick, const ::Color &color) {
        ::DrawLineEx(*this, endPos, thick, color);
        return *this;
    }

    inline Vector2 &DrawLineBezier(const ::Vector2 &endPos, float thick, const ::Color &color) {
     ...
     */
    inline Vector2 &DrawCircle(float radius, const ::Color &color) {
        ::DrawCircleV(*this, radius, color);
        return *this;
    }

    inline Vector2 &DrawRectangle(const ::Vector2 &size, const ::Color &color) {
        ::DrawRectangleV(*this, size, color);
        return *this;
    }

    inline Vector2 &DrawPoly(int sides, float radius, float rotation, const ::Color &color) {
     ...
     */
    inline bool CheckCollisionCircle(float radius1, const ::Vector2 &center2, float radius2) const {
     ...
     */
    inline bool CheckCollisionCircle(float radius, const ::Rectangle &rec) const {
     ...
     */
    inline bool CheckCollision(const ::Rectangle &rec) const {
     ...
     */
    inline bool CheckCollision(const ::Vector2 &center, float radius) const {
     ...
     */
    inline bool CheckCollision(const ::Vector2 &p1, const ::Vector2 &p2, const ::Vector2 &p3) const {
    ...
    inline bool CheckCollisionLines(
            const ::Vector2 &endPos1,
            const ::Vector2 &startPos2, const ::Vector2 &endPos2,
