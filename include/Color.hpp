...
class Color : public ::Color {
 public:
     ...
     */
    Color(const ::Vector4 &normalized) {
     ...
     * Draw a pixel
     */
    inline Color &DrawPixel(const ::Vector2 &pos) {
        ::DrawPixelV(pos, *this);
        return *this;
    }
    ...
    inline Color &DrawLine(const ::Vector2 &startPos, const ::Vector2 &endPos) {
        ::DrawLineV(startPos, endPos, *this);
        return *this;
    }

    inline Color &DrawLine(const ::Vector2 &startPos, const ::Vector2 &endPos, float thick) {
        ::DrawLineEx(startPos, endPos, thick, *this);
        return *this;
    }

    inline Color &DrawLineBezier(const ::Vector2 &startPos, const ::Vector2 &endPos, float thick) {
    ...
    inline Color &DrawText(const ::Font &font, const std::string &text, const ::Vector2 &position,
    ...
    inline Color &DrawRectangle(const ::Vector2 &position, const ::Vector2 &size) {
        ::DrawRectangleV(position, size, *this);
        return *this;
    }

    inline Color &DrawRectangle(const ::Rectangle &rec) {
        ::DrawRectangleRec(rec, *this);
        return *this;
    }

    inline Color &DrawRectangle(const ::Rectangle &rec, const ::Vector2 &origin, float rotation) {
    ...
    inline Color &DrawRectangleLines(const ::Rectangle &rec, int lineThick) {
     ...
     */
    Color AlphaBlend(const ::Color &dst, const ::Color &tint) const {
