...
class Rectangle : public ::Rectangle {
 public:
    ...
    Rectangle(const ::Vector2 &size) : ::Rectangle{0, 0, size.x, size.y} {}
     ...
     */
    inline Rectangle &Draw(const ::Color &color) {
        ::DrawRectangle(static_cast<int>(x), static_cast<int>(y), static_cast<int>(width),
            static_cast<int>(height), color);
        return *this;
    }

    inline Rectangle &Draw(const ::Vector2 &origin, float rotation, const ::Color &color) {
        ::DrawRectanglePro(*this, origin, rotation, color);
        return *this;
    }

    inline Rectangle &DrawGradientV(const ::Color &color1, const ::Color &color2) {
        ::DrawRectangleGradientV(static_cast<int>(x), static_cast<int>(y), static_cast<int>(width),
            static_cast<int>(height), color1, color2);
        return *this;
    }

    inline Rectangle &DrawGradientH(const ::Color &color1, const ::Color &color2) {
        ::DrawRectangleGradientH(static_cast<int>(x), static_cast<int>(y), static_cast<int>(width),
            static_cast<int>(height), color1, color2);
        return *this;
    }

    inline Rectangle &DrawGradient(const ::Color &col1, const ::Color &col2, const ::Color &col3, const ::Color &col4) {
        ::DrawRectangleGradientEx(*this, col1, col2, col3, col4);
        return *this;
    }

    inline Rectangle &DrawLines(const ::Color &color) {
        ::DrawRectangleLines(static_cast<int>(x), static_cast<int>(y), static_cast<int>(width),
            static_cast<int>(height), color);
        return *this;
    }

    inline Rectangle &DrawLines(const ::Color &color, int lineThick) {
        ::DrawRectangleLinesEx(*this, lineThick, color);
        return *this;
    }

    inline Rectangle &DrawRounded(float roundness, int segments, const ::Color &color) {
     ...
     */
    inline bool CheckCollision(const ::Rectangle &rec2) const {
     ...
     */
    inline ::Rectangle GetCollision(const ::Rectangle &rec2) const {
     ...
     */
    inline bool CheckCollision(const ::Vector2 &point) const {
     ...
     */
    inline bool CheckCollision(const ::Vector2 &center, float radius) {
