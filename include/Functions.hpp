 ...
 */
RLCPPAPI inline std::string LoadFileText(const std::string& fileName) {
 ...
 */
RLCPPAPI inline std::vector<std::string> GetDirectoryFiles(const std::string& dirPath) {
    int count;
 ...
 */
RLCPPAPI inline std::vector<std::string> GetDroppedFiles() {
    int count;
